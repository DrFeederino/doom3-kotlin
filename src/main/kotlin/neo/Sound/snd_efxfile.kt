...
class snd_efxfile {
    ...
    class idEFXFile {
        ...
        fun ReadEffect(src: idLexer, effect: idSoundEffect): Boolean {
            ...
            // reverb effect
            if (token.toString() != "reverb") { // other effect (not supported at the moment)
            ...
            do {
                ...
                when {
                    t == "environment" -> { // <+KittyCat> the "environment" token should be ignored (efx has nothing equatable to it)
                        src.ParseInt()
                    }

                    t == "environment size" -> { // density = clamp(pow(size, 3) / 16, 0, 1)
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_DENSITY, %.3f) failed: 0x%x", size, err
                        )
                    }
                    ...
                    t == "environment diffusion" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_DIFFUSION, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "room" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_GAIN, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "room hf" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_GAINHF, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "room lf" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_GAINLF, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "decay time" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_DECAY_TIME, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "decay hf ratio" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_DECAY_HFRATIO, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "decay lf ratio" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_DECAY_LFRATIO, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "reflections" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_REFLECTIONS_GAIN, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "reflections delay" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_REFLECTIONS_DELAY, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "reverb" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_LATE_REVERB_GAIN, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "reverb delay" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_LATE_REVERB_DELAY, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "echo time" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_ECHO_TIME, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "echo depth" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_ECHO_DEPTH, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "modulation time" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_MODULATION_TIME, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "modulation depth" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_MODULATION_DEPTH, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "air absorption hf" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_AIR_ABSORPTION_GAINHF, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "hf reference" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_HFREFERENCE, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "lf reference" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_LFREFERENCE, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "room rolloff factor" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffectf(AL_EAXREVERB_ROOM_ROLLOFF_FACTOR, %.3f) failed: 0x%x", v, err
                        )
                    }
                    ...
                    t == "flags" -> {
                        ...
                        err = AL10.alGetError()
                        if (err != AL10.AL_NO_ERROR) Common.common.Warning(
                            "alEffecti(AL_EAXREVERB_DECAY_HFLIMIT, %d) failed: 0x%x", decayHfLimit, err
        ...
        /*
         ...
         ===============
         */
        fun Clear() { // NOTE: Differs from C++ — C++ uses effects.DeleteContents(true) which calls delete
